...
const setAtualizarDiretor = async function (idDiretor, dadoAtualizado, contentType) {
    try {
        ...
        if (String(contentType).toLowerCase() == 'application/json') {
            let dadosID = diretoresDAO.selectByIdDiretor()
            ...
            if (idDiretor == '' || idDiretor == undefined || idDiretor == isNaN(idDiretor) || idDiretor == null) {
                ...
                if (dadoAtualizado.nome == ''               || dadoAtualizado.nome == undefined             || dadoAtualizado.nome == null              || dadoAtualizado.nome.length > 100             ||
                    ...
                    if (validateStatus) {
                        ...
                        let dadosDiretor = await diretoresDAO.updateDiretor(idDiretor, dadoAtualizado)
...
const setExcluirDiretor = async function (id) {
    ...
    if (idDiretor == '' || idDiretor == undefined || idDiretor == isNaN(idDiretor) || idDiretor == null) {
        ...
        if (validarId > 0) {
            ...
            dadosDiretor = await diretoresDAO.deleteDiretor(idDiretor)
...
const getNomeDiretor = async function (nome) {
    ...
    if (nomeDiretor == '' || nomeDiretor == undefined) {
        ...
        let dadosDiretor = await diretoresDAO.selectNomeDiretor(nomeDiretor)
